...
\item similarly use \mintinline{Seq.filterFst}/\mintinline{Seq.filterSnd} or \mintinline{fsharp}{Seq.chooseFst}/\mintinline{fsharp}{Seq.chooseSnd} to select elements by data or index:
